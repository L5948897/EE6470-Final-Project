...
public:
	...
	addr_t sobelFilter0_start_addr = 0x73000000;
 	addr_t sobelFilter0_size = 0x00001000;
 	addr_t sobelFilter0_end_addr = sobelFilter0_start_addr + sobelFilter0_size - 1;
	addr_t sobelFilter1_start_addr = 0x73001000;
 	addr_t sobelFilter1_size = 0x00001000;
...
int sc_main(int argc, char **argv) {
	 ...
	 */
	core0.init(instr_mem_if0, data_mem_if0, &clint, entry_point, rv64_align_address(opt.mem_end_addr));
	core1.init(instr_mem_if1, data_mem_if1, &clint, entry_point, rv64_align_address(opt.mem_end_addr));
